...
def OutputAudioEmbeddings(pathIn, row):
    ...
    if os.path.isfile(full_path_cut):
      ...
      with tf.Graph().as_default(), tf.Session() as sess:
        ...
        np.save('/lfs01/workdirs/shams010/shams010u1/code/audio_features/'+split+'/'+video_id,postprocessed_batch)
...
def main():
    video_data_path = "/lfs01/workdirs/shams010/shams010u1/code/test_videodatainfo_nosen_2017.json"
    video_save_path = '/lfs01/workdirs/shams010/shams010u1/datasets/msrvtt/videos/'
